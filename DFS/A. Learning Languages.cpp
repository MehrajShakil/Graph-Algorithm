...
int main()
{
    ...
    ll n,m,zero=0,connected_component=0;
    cin >> n >> m;
    ...
    for(ll i=1; i<=n; i++)
    {
        ...
        {
            cin >> x;
            adj[parent].push_back(x);
            adj[x].push_back(parent);
        }
    }
    ...
    if(zero==n)cout<<zero<<ses;
    else cout<<zero+connected_component-1<<ses;
